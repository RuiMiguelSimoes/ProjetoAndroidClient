...
public class FriendsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TextView numeroDeAmigosTv = view.findViewById(R.id.numero_amigos_tv);
        ...
        databaseReference.child("Utilizadores").child(user.getUid()).child("amigos").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                {
                    numeroDeAmigosTv.setText("Não tens amigos :(");
                }

                else{
                    numeroDeAmigosTv.setText("Tens "+String.valueOf(snapshot.getChildrenCount()) +" amigos! :D" );
                }
            }
            @Override
            public void onCancelled(@NonNull DatabaseError error) {
